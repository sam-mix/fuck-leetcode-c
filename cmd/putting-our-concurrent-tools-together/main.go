...
func getResultC(ctx context.Context, inputC CIn) (COut, error) {
	return inputC.C, nil
}

func getResultB(ctx context.Context, bOut BOut) (BOut, error) {
	return bOut, nil
}

func getResultA(ctx context.Context, aOut AOut) (AOut, error) {
	return aOut, nil
...
func main() {
	GatherAndProcess(context.Background(), Input{})
}
